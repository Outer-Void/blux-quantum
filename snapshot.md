...
- Default branch: work
- HEAD commit hash: 91f299248721ba49ab13ef1b1a5d43d6f4b34aeb
- Snapshot timestamp (UTC): 2026-01-22T05:18:25.113762+00:00
- Total file count (excluding directories): 100
- Description: BLUX Quantum (`blux`)
...
- .git/HEAD [text]
- .git/config [text]
- .git/description [text]
- .git/hooks/
- .git/hooks/applypatch-msg.sample [text]
- .git/hooks/commit-msg.sample [text]
- .git/hooks/fsmonitor-watchman.sample [text]
- .git/hooks/post-update.sample [text]
- .git/hooks/pre-applypatch.sample [text]
- .git/hooks/pre-commit.sample [text]
- .git/hooks/pre-merge-commit.sample [text]
- .git/hooks/pre-push.sample [text]
- .git/hooks/pre-rebase.sample [text]
- .git/hooks/pre-receive.sample [text]
- .git/hooks/prepare-commit-msg.sample [text]
- .git/hooks/push-to-checkout.sample [text]
- .git/hooks/sendemail-validate.sample [text]
- .git/hooks/update.sample [text]
- .git/index [binary]
- .git/info/
- .git/info/exclude [text]
- .git/logs/
- .git/logs/HEAD [text]
- .git/logs/refs/
- .git/logs/refs/heads/
- .git/logs/refs/heads/work [text]
- .git/objects/
- .git/objects/pack/
- .git/objects/pack/pack-935a0bd6a0f7065d8863b2602466a34ad65e9b89.idx [binary]
- .git/objects/pack/pack-935a0bd6a0f7065d8863b2602466a34ad65e9b89.pack [binary]
- .git/objects/pack/pack-935a0bd6a0f7065d8863b2602466a34ad65e9b89.rev [binary]
- .git/packed-refs [text]
- .git/refs/
- .git/refs/heads/
- .git/refs/heads/work [text]
- .github/
- .github/workflows/
...
- ROLE.md [text]
- blux_quantum/
- blux_quantum/__init__.py [text]
- blux_quantum/audit.py [text]
- blux_quantum/cli.py [text]
- blux_quantum/config.py [text]
- blux_quantum/diagnostics.py [text]
- blux_quantum/dispatch.py [text]
- blux_quantum/envelope.py [text]
- blux_quantum/environment.py [text]
- blux_quantum/orchestrator.py [text]
- blux_quantum/plugins/
- blux_quantum/plugins/__init__.py [text]
- blux_quantum/plugins/loader.py [text]
- blux_quantum/plugins/quantum_framework/
- blux_quantum/plugins/quantum_framework/__init__.py [text]
- blux_quantum/plugins/quantum_framework/loader.py [text]
- blux_quantum/stability.py [text]
- blux_quantum/telemetry.py [text]
- blux_quantum/tui.py [text]
- bq/
- bq/__init__.py [text]
- bq/cli.py [text]
- bq_fsp/
- bq_fsp/README.md [text]
- bq_fsp/__init__.py [text]
- bq_fsp/cli.py [text]
- bq_fsp/ignore.py [text]
- bq_fsp/pyproject.toml [text]
- bq_fsp/rules.py [text]
- bq_fsp/sarif.py [text]
- bq_fsp/scanner.py [text]
- docs/
...
- scripts/bluxq [text]
- scripts/bq [text]
- scripts/demo_install_alias.ps1 [text]
- scripts/gen_filetree.py [text]
- scripts/generate_command_reference.py [text]
- scripts/physics_check.sh [text]
- scripts/physics_checks.py [text]
- scripts/physics_tests.sh [text]
- scripts/update_readme_filetree.py [text]
- tests/
- tests/conftest.py [text]
- tests/test_cli.py [text]
- tests/test_physics.py [text]
- tests/test_plugins.py [text]
- tests/test_reference_generator.py [text]
- tests/test_role_contract.py [text]
- tests/test_telemetry.py [text]
...
Kind: text
Size: 102
Last modified: 2026-01-22T05:15:52.330487+00:00

CONTENT:
91f299248721ba49ab13ef1b1a5d43d6f4b34aeb		branch 'main' of https://github.com/Outer-Void/blux-quantum


FILE: .git/HEAD
Kind: text
Size: 21
Last modified: 2026-01-22T05:15:52.382491+00:00
...
Kind: text
Size: 92
Last modified: 2026-01-22T05:15:52.418494+00:00
...
Kind: text
Size: 73
Last modified: 2026-01-22T05:15:51.318408+00:00
...
Kind: text
Size: 478
Last modified: 2026-01-22T05:15:51.314408+00:00
...
Kind: text
Size: 1643
Last modified: 2026-01-22T05:15:51.310407+00:00
...
Kind: binary
Size: 6634
Last modified: 2026-01-22T05:15:52.446496+00:00
...
CONTENT:
0000000000000000000000000000000000000000 91f299248721ba49ab13ef1b1a5d43d6f4b34aeb Codex <codex@openai.com> 1769058952 +0000	checkout: moving from master to work
...
CONTENT:
0000000000000000000000000000000000000000 91f299248721ba49ab13ef1b1a5d43d6f4b34aeb Codex <codex@openai.com> 1769058952 +0000	branch: Created from FETCH_HEAD


FILE: .git/objects/pack/pack-935a0bd6a0f7065d8863b2602466a34ad65e9b89.idx
Kind: binary
Size: 7540
Last modified: 2026-01-22T05:15:52.270483+00:00
...
FILE: .git/objects/pack/pack-935a0bd6a0f7065d8863b2602466a34ad65e9b89.pack
Kind: binary
Size: 125880
Last modified: 2026-01-22T05:15:52.266482+00:00
...
FILE: .git/objects/pack/pack-935a0bd6a0f7065d8863b2602466a34ad65e9b89.rev
Kind: binary
Size: 976
Last modified: 2026-01-22T05:15:52.290484+00:00
...
CONTENT:
91f299248721ba49ab13ef1b1a5d43d6f4b34aeb


FILE: .github/workflows/ci.yml
Kind: text
Size: 672
Last modified: 2026-01-22T05:15:52.370491+00:00
...
Kind: text
Size: 11357
Last modified: 2026-01-22T05:15:52.374491+00:00
...
Kind: text
Size: 405
Last modified: 2026-01-22T05:15:52.378491+00:00
